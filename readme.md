...
1. Define a class extending `\WPGMZA\CustomFieldFilterWidget` [see here](https://github.com/CodeCabin/wp-google-maps-range-slider-filter-widget/blob/master/wp-google-maps-range-slider-filter-widget.php)
...
1. Define a class extending `\WPGMZA\CustomFieldFilter` [see here](https://github.com/CodeCabin/wp-google-maps-range-slider-filter-widget/blob/master/wp-google-maps-range-slider-filter.php)
